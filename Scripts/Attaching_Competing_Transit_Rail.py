...
if __name__ == "__main__":
    ...
    for year in YEARS:
        ...
        for buffer_end in BUFFER_ENDS:
            ...
            bus_geo.crs = {'init':'epsg:4269'}
            bus = gp.sjoin(buffers[['STOP_ID','geometry']],bus_geo,how = 'left')
            ...
            if year == 2009:
                ...
                transit = bart.merge(cal.drop('geometry',axis =1),on = 'STOP_ID',how = 'outer').merge(bus.drop('geometry',axis = 1),on = 'STOP_ID',how = 'outer').merge(bike.drop('geometry',axis = 1), on = 'STOP_ID',how = 'outer')
